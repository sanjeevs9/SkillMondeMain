...
export default function Blogs(){
    return(
        <>
        <div className="flex flex-col  justify-center gap-5 pb-1 md:pb-5 lg:gap-7 sm:pt-10">
            <div className="text-center text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-6 md:mb-12 tracking-tight ">
                Blogs
            </div>
