...
export default function FreelanceSection(){
    return(
        <>
        <div className="pt-10 ">
                <div className="flex p-5 xl:h-[40rem] h-[30rem] sm:h-[40rem]  md:h-[30rem]  md:flex-row flex-col-reverse ">
                    <div className="bg-[#125045] md:w-3/6 w-full md:rounded-l-2xl  md:h-auto h-full">
                            <div className="text-3xl sm:text-5xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl text-white font-semibold p-6 md:p-10  lg:p-16 xl:p-18 h-5/6  md:h-auto ">
                                <div>
                                Start ‎ 
                                <span className="text-PGreen">Freelancing</span>:
                                </div>
                                <div className="text-sm sm:text-lg md:text-base xl:text-2xl font-normal pt-2">Begin your freelance journey now.</div>
                                <div className="pt-8 xl:pt-12">Hire Top ‎ 
                                    <span className="text-PGreen">Freelancers</span>:
                                </div>
                                <div className="text-sm sm:text-lg md:text-base font-normal xl:text-2xl pt-2 pb-5 md:pb-10">Get your work done by the best freelancers</div>
