            ...
            <div className="flex flex-col md:flex-row w-full p-5 gap-5 lg:gap-10  md:h-[25rem] lg:h-[28rem] xl:h-[31rem] ">
                ...
                <div className="w-full md:w-3/4 pl-5 md:pl-0">
                    ...
                    <div className="pl-6 pt-3 lg:pt-4 xl:pt-5 flex gap-4 sm:gap-7 lg:gap-7">
                        <button onClick={()=>{window.open("https://skillmonde.graphy.com")}} className="bg-PGreen p-2 pl-5 pr-5 sm:p-3 sm:pl-10 sm:pr-10  lg:p-[2.5] lg:pl-8 lg:pr-8 xl:p-3 xl:pl-10 xl:pr-10 rounded-lg text-sm font-medium transition ease-linear delay-150 hover:-translate-y-[0.5px] duration-300 hover:scale-105">Sign up</button>
                        <button onClick={()=>{window.open("https://skillmonde.graphy.com")}} className="border border-PGreen p-2 pl-5 pr-5 sm:p-3 sm:pl-10 sm:pr-10 lg:p-3 lg:pl-8 lg:pr-8  xl:p-3 xl:pl-10 xl:pr-10 rounded-lg font-medium text-sm transition ease-linear delay-150 hover:-translate-y-[0.5px] duration-300 hover:scale-105">Visit Now</button>
                    </div>
                </div>
            </div>
        </div>
